...
* 
* @component
* @param {Function} onSignUp - Callback function for form submission
* @param {string} error - Error message to display
* @param {boolean} success - Success status for registration
  ...
  */
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length > 0) {
      console.log('Errors detected in the registration form:', errors);
